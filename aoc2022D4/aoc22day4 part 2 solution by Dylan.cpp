...
int main() {
  ...
  for (int i=0; i<1000; i++) {
    ...
    if (lowerbound1_num <= lowerbound2_num) {
      if (upperbound1_num >= lowerbound2_num) {
        count = count+1;
        lowerbound1_num = 0;
        upperbound1_num = 1;
        lowerbound2_num = 2;
    ...
    if (lowerbound1_num <= upperbound2_num) {
      if (upperbound1_num >= upperbound2_num) {
        count = count+1;
        lowerbound1_num = 0;
        upperbound1_num = 1;
    ...
    if (lowerbound2_num <= lowerbound1_num) {
      if (upperbound2_num >= upperbound1_num) {
        count = count+1;
        lowerbound1_num = 0;
        upperbound1_num = 1;
        lowerbound2_num = 2;
    ...
    if (lowerbound2_num <= lowerbound1_num) {
      if (upperbound2_num >= lowerbound1_num) {
        count = count+1;
        lowerbound1_num = 0;
        upperbound1_num = 1;
        lowerbound2_num = 2;
    ...
    if (lowerbound2_num <= upperbound1_num) {
      if (upperbound2_num >= upperbound1_num) {
        count = count+1;
        lowerbound1_num = 0;
        upperbound1_num = 1;
